      ...
      <div className="pointer-events-auto flex items-end gap-2">
        ...
        {!isCollapsed && (
          <div className="glass-panel px-1 py-1 flex items-center gap-0.5 animate-in slide-in-from-left-2 duration-300 fade-in">
            ...
            <div className="w-px h-5 bg-zinc-200 dark:bg-white/10 mx-1"></div>
            <button onClick={onZoomOut} className={`w-8 h-8 flex items-center justify-center transition-colors font-mono text-lg ${btnClass}`} title="Zoom Out">-</button>
            <button onClick={onZoomIn} className={`w-8 h-8 flex items-center justify-center transition-colors font-mono text-lg ${btnClass}`} title="Zoom In">+</button>
        ...
        <div className="glass-panel p-1">
          <button
            ...
            className={`p-2 transition-colors hover:bg-black/5 dark:hover:bg-white/10 text-zinc-500 dark:text-zinc-400`}
