...
export const FormatToolbar: React.FC<FormatToolbarProps> = ({ onInsertMarkdown }) => {
  ...
  const btnClass = "p-1.5 hover:bg-black/5 dark:hover:bg-white/10 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors";
