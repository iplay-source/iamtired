...
export const Canvas: React.FC<CanvasProps> = ({
  ...
  showGrid, snapToGrid, globalFont, globalHeaderFont, globalHeaderFontSize, globalHeaderColor, globalBodyFontSize, globalColor, isDarkMode, onPanDraggingChange, onSelectionDraggingChange,
  onContextMenu
}) => {
